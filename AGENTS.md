...
Workshop `0.0.25-dev` currently provides hierarchy-safe MIAPI part salvage/replacement for tools, Truly Modular: Archery `2.2`, and Truly Modular: Armory `2.2`; ordinary tool/ranged/armor converters; readable detached-part and complete-equipment naming (including generated materials); pack-owned zinc/brass/rose-quartz materials; a modular equipment audit command; randomized descendant modules/materials in loot; and canonical copper crafting. Automatic armor and archery conversion is conservative: mundane material variants convert, while magical, boss, relic, powered, spellcaster, and other ability-bearing equipment remains protected. Both Ice and Fire and Create Stuff & Additions copper tools convert to `miapi:metal/copper`, but only Ice and Fire's copper tool recipes remain enabled to prevent ambiguous autocrafting outputs.
