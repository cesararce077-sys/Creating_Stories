...
Relic Loot Viewer is a client-side NeoForge integration for Minecraft 1.21.1. It adds a **Relic Sources** category to JEI-compatible recipe viewers for every item implementing Relics' `IRelicItem` API.
